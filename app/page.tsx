...
const navItems = [
  { label: "Github", href: "https://git.new/Arrow", icon: GitHubLogoIcon },
  { label: "Docs", href: "https://docs.Arrow.sh", icon: BookOpenIcon },
];
...
const Footer = () => {
  return (
    <footer className="mt-auto py-4">
      ...
      >
        <p>© 2024 Arrow. All rights reserved.</p>
        <span>|</span>
        <Link
          href="https://x.com/Arrow_sh"
          target="_blank"
...
export default function Home() {
  ...
  if (isMaintenanceMode) {
    login = () => {
      window.location.href = "https://x.com/Arrow_sh";
    };
  }
